...
{
  /// <summary>First table columm.</summary>
...
public class Formulas
{
  ...
  public void CalculateFormulas(List<string?[]> store)
  {
    if (store == null)
      return;
    foreach (var f in List)
    {
      ...
      if (f.Function == "sum")
      {
        if (f.Column1 >= 0 && f.Row1 >= 0 && f.Column2 >= 0 && f.Row2 >= 0)
        {
          ...
          for (var r = f.Row1; r <= f.Row2; r++)
          {
            ...
            {
              var v = store[r][c + Formula.Offset];
      ...
      else if (f.Function == "count")
      {
        if (f.Column1 >= 0 && f.Row1 >= 0 && f.Column2 >= 0 && f.Row2 >= 0)
        {
          ...
          for (var r = f.Row1; r <= f.Row2; r++)
          {
            ...
            {
              var v = store[r][c + Formula.Offset];
              if (!string.IsNullOrWhiteSpace(Functions.MakeBold(v, true)))
                count++;
            }
          }
      ...
      else if (f.Function == "days")
      {
        ...
        if (f.Column1 >= 0 && f.Row1 >= 0 && f.Column2 >= 0 && f.Row2 >= 0)
        {
          var v = store[f.Row1][f.Column1 + Formula.Offset];
          var val1 = Functions.ToDateTime(Functions.MakeBold(v, true));
          if (val1.HasValue)
          {
      ...
      if (val != null)
      {
        ...
        store[f.Row][f.Column + Formula.Offset] = f.Value;
      }
    }
  }
