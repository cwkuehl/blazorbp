...
""");
      ...
      sbt7.AppendLine($$"""    // SetMandatoryHiddenReadonly(nameof({{Functions.ToFirstUpper(c.Name)}}), false, false, mode == Delete, false);""");
    }
    var model = $$"""
...
{{Functions.Iif(sbt7.Length <= 2, "", sbt7.ToString())}}
