...
public class GladeParserTests
{
  ...
  public void GenerateBlazor()
  {
    ...
    // Generator.Generate($"{basepath}/HH/HH500Balance.glade", null, null, resfile, genpath);
    Generator.Generate($"{basepath}/HH/HH510Interface.glade", null, null, resfile, genpath);
  }
}
